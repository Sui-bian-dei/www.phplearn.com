            ...
            <div id="primary" class="site-content">
                <div id="content" role="main">
                    ...
                    <article>
                        ...
                        <img src="<?php echo $data[0]['img'] ?>" alt="image_err">
                        ...
                        <footer class="entry-meta">
                            ...
                            <a href="/index.html?time=2020-10-02" title="2020-10-02" rel="bookmark">
                                <time class="entry-date" datetime="2020-10-02"><?php echo $data[0]['date'] ?></time>
                            </a>。 属于 
                            <a href="/index.html?cate=4" title="查看 Linux中的全部文章" rel="category"><?php echo $data[0]['class'] ?></a> 分类
                        </footer>
                    </article>
